...
You may either completely re-write the system from scratch or make appropriate changes to the existing code. You may add new files or delete files as you wish. Usage of AI tools is allowed but be sure to review and have a very good grasp of the code base. 
